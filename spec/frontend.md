...
The Assigned Member column/edit surfaces and edits the single assignee per Yearly Company (inline, cell-level, per Principle 4) via `CompanyAssignment` (0..1 — `spec/model.md#CompanyAssignment`).
