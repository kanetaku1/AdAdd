...
The current AdAdd implementation covers all three steps — creation, role assignment, and disable/re-enable — plus listing, via a single screen: see `spec/frontend.md` → Settings → User List.
