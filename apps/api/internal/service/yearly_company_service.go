...
func (s *YearlyCompanyService) ListByYear(yearId string) ([]model.YearlyCompanyResponse, error) {
...
func (s *YearlyCompanyService) GetByID(id string) (*model.YearlyCompanyResponse, error) {
